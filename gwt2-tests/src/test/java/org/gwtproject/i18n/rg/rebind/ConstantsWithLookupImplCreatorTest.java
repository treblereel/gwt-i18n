...
/*  private static final MockJavaResource SINGLE_ENTRY_MESSAGES = new MockJavaResource(
  ...
  private ExecutableElement stringMethod;

  private ExecutableElement intMethod;
  ...
  public void testClassEpilogCallCreatesNeededPartitonLookups() {
    List<ExecutableElement> missingPartition0 = Arrays.asList(stringMethod, intMethod);
    List<List<ExecutableElement>> methodToCreatePartitionLookups = new ArrayList<>();
