...
public interface ClientBundleFields {
     ...
     * @return the identifier that must be used to access the field
     */
    String define(TypeElement type, String name, String initializer, boolean isStatic,
                  boolean isFinal);
     ...
     * @return the identifier that must be used to access the field
     */
    String define(ArrayType array, String name, String initializer, boolean isStatic,
                  boolean isFinal);
