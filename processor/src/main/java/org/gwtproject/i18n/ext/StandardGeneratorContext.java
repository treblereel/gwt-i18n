...
import org.gwtproject.i18n.rg.resource.impl.PropertyOracleImpl;
import org.gwtproject.i18n.rg.resource.impl.ResourceOracleImpl;
import org.gwtproject.i18n.rg.util.DiskCache;
import org.gwtproject.i18n.rg.util.GeneratedUnit;
 ...
 * Created by treblereel 11/12/18
 */
public class StandardGeneratorContext implements GeneratorContext {
    ...
    @Override
    public PrintWriter tryCreate(TreeLogger logger, String packageName, String simpleTypeName) throws UnableToCompleteException {
        String typeName;
    ...
    public OutputStream tryCreateResource(TreeLogger logger, String partialPath) throws UnableToCompleteException {
        logger = logger.branch(TreeLogger.DEBUG, "Preparing pending output resource '" + partialPath + "'",
                null);
        ...
        if (pendingResources.containsKey(partialPath)) {
            ...
            logger.log(TreeLogger.DEBUG, "The file '" + partialPath + "' is already a pending resource",
                    null);
            return null;
        }
