...
class LookupMethodCreator extends AbstractMethodCreator {
  ...
  @Override
  public void createMethodFor(TreeLogger logger, ExecutableElement targetMethod, String key,
   ...
   */
  void createMethodFor(ExecutableElement targetMethod, List<ExecutableElement> methodsToCreate,
  ...
  void createPartitionLookup(String partitionMethodName, ExecutableElement targetMethod,
      List<ExecutableElement> methodsToCreate, String nextPartitionMethod) {
    println("");
  ...
  private String createThrowMissingResourceException() {
    ...
    result = MessageFormat.format(format, "arg0", this.currentCreator.getTarget().getQualifiedName().toString());
    return result;
  }
}
