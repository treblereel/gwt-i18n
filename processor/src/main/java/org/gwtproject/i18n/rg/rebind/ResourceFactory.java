...
public abstract class ResourceFactory {
  ...
  private static void addFileResources(TreeLogger logger, GeneratorContext context, TypeElement clazz, GwtLocale locale,
                                       ResourceList resources) {
    // TODO: handle classes in the default package?
    String targetPath = MoreElements.getPackage(clazz).getQualifiedName().toString() + '.'
