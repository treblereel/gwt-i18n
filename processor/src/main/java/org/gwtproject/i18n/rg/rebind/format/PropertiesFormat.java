...
import org.gwtproject.i18n.rg.rebind.AbstractResource;
import org.gwtproject.i18n.rg.rebind.AnnotationsResource;
...
public class PropertiesFormat implements MessageCatalogFormat {
   ...
   *      java.io.File, com.google.gwt.core.ext.typeinfo.TypeElement)
   */
  public void write(TreeLogger logger, String locale,
                    AbstractResource.ResourceList resourceList, PrintWriter out, TypeElement messageInterface) {
