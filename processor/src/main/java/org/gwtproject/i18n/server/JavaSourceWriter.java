...
public class JavaSourceWriter extends SourceWriterBase {
    ...
    private static final Pattern PKG_REGEX_BOTH = Pattern.compile("(org\\.gwtproject|javax?)\\..*");
    private static final Pattern PKG_REGEX_GOOGLE = Pattern.compile("org\\.gwtproject\\..*");
