...
public class PropertyCatalogFactory implements MessageCatalogFactory {
    ...
    public Writer getWriter(Context context, String fileName) {
        ...
        if (pw == null) {
            ...
            PropertyCatalogFactory.PropertiesWriter writer = new PropertyCatalogFactory.PropertiesWriter(pw);
            return writer;
        }
    }
    ...
    private static class PropertiesWriter extends DefaultVisitor implements Writer {
        ...
        public MessageVisitor visitMessage(Message msg, MessageTranslation trans) {
            ...
            if (selectorIndices.length > 0) {
                if (selectorIndices[0] >= 0) {
                    ...
                    this.writer.println("# the message according to Plural Count and Selector entries above.");
                } else {
        ...
        public void visitTranslation(String[] formNames, boolean isDefault, MessageStyle style, String msg) {
            if (!isDefault) {
                if (msg == null) {
                    msg = "";
                }
