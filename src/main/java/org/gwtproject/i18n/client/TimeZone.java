...
public class TimeZone implements org.gwtproject.i18n.shared.TimeZone {
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getGMTString(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getID()
   */
  public String getID() {
    return timezoneID;
  }
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getISOTimeZoneString(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getLongName(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getOffset(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getRFCTimeZoneString(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getShortName(java.util.Date)
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#getStandardOffset()
   */
  ...
  /* (non-Javadoc)
   * @see org.gwtproject.i18n.client.TimeZoneIntf#isDaylightTime(java.util.Date)
   */
